...
<table id="cabecalho" border="1">
    <tr>
        <td align="center">
            <h1>FICHA DE INSCRIÇÃO<br />{{$inscricao->categoria->sigla}} - 2023</h1>
        </td>
    </tr>
</table>
<table>
    <tr>
        ...
        <strong>Nível:</strong> {{$inscricao->categoria->categoria}} - {{$inscricao->categoria->sigla}}
            <br/>
            <br/>
            <strong>Arma / Quadro / Serviço:</strong> {{$inscricao->area->area}}
...
<table>
    <tr>
        <td align="center" colspan="4">
            <strong><hr />HISTÓRICO MILITAR</td>
        </td>
    </tr>
    @if($listaTitulos->count())
        <tr>
            <th>Último posto na ativa</th>
            <th>OM de realização do CPOR / NPOR</th>
            <th>Punição - Grau</th>
            <th>Data de Praça</th>
        </tr>
