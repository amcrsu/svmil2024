        ...
        <div class="col-md-12 col-sm-6 col-xs-12">
                ...
                <div class="panel-body">
                    ...
                    @if($inscricao->categoria->id == 3 AND $listaHabilitacoes->count() == 1) 
                        ...
                        @if(isset($listaHabilitacoes))
                            @if(($inscricao->area->id >= 1) and ($inscricao->area->id <= 10) and ($listaHabilitacoes->count() == 1))
            ...
            <div class="panel panel-default">
                ...
                <p>
                    ...
                    @if($inscricao->categoria->id == 3 AND $listaTitulos->count() == 1) -->
                       <!-- ?php $disabled = "0"; $incluirTitulo = "1"; ?>
                        @if(isset($listaTitulos)) -->
                      <!--      @if(($inscricao->area->id ==1) and ($listaTitulos->count() == 1)) -->
                        <!-- regra para habilitar o botão "Finalizar Inscrição" -->
