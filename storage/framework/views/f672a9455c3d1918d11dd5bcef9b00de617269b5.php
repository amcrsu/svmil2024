    ...
    <div class="panel-body">
        ...
        <div class="form-group<?php echo e($errors->has('guaId') ? ' has-error' : ''); ?>">
            ...
            <div class="col-sm-4">
                ...
                <p class="alert alert-info col-sm-12" style="margin-top:0.5em;">Preencha os campos supracitados conforme o Anexo "C" ao Aviso de Convocação nº 006 - SSMR/10RM. </p>
            </div>
