<div class="alert alert-info" role="alert">
        ...
        <ul>
            <li>Para o "Curso Profissionalizante", informe <b>apenas 01 Certificado</b>, desde que seja na área pretendida;</li>
...
<div class="form-group<?php echo e($errors->has('dtConclusaoDiploma') ? ' has-error' : ''); ?>">
    ...
    <div class="col-sm-2">
        <input type="text" class="form-control readonly" readonly id="dtConclusaoDiploma" name="dtConclusaoDiploma" data-mask="00/00/0000" required>
    </div>
