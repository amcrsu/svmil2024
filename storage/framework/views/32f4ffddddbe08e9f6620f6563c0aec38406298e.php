...
<div class=" head-title">
    ...
    <h4 class="section-title">PROCESSO DE SELEÇÃO 2022 PARA 2023</h4>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="media">
                    ...
                    <div class="media-body">
                        ...
                        <p>Processo visando à seleção de candidatos voluntários para a prestação do Serviço Militar Especialista Temporário como Cabo Especialista Temporário, na área da 10ª Região Militar, para o ano de 2023.</p>
                        
                        <p class="alert alert-success" role="alert">O Sistema de inscrição para Cabo Especialista Temporário estará disponível a partir das <strong>09:00h do dia 15 de agosto de 2022 até às 12:00h do dia 02 de setembro de 2022, conforme o Aviso de Seleção nº 008 - SSMR/10, de 04 de agosto de 2022.</strong>
                        </p>
                        ...
                        <p class="alert alert-info" role="alert">
                            ...
                            <a href="https://www.10rm.eb.mil.br/images/artigos/servicos/ssmr/selecao-cet/2022-2/AVISO_CONVOCACAO_Nr_008_CET_2023.pdf" target="_blank" title="Aviso de Seleção para Cabo Especialista Temporário - CET">
                                <i style="float:left; margin-right:7px;display:block;" class="fa fa-file-pdf-o fa-3x" aria-hidden="true"></i>Aviso de Convocação nº 008 - SSMR / 10RM, de 04 de agosto de 2022.
                            </a>
                        </p>
                    </div>
                </div>
                ...
                <div class="media">
                    ...
                    <div class="media-body">
                      ...
                      <!--  <p class="alert alert-danger" role="alert" style="text-align:center;">INSCRIÇÕES ENCERRADAS!!!</p>   -->
                        ...
                        <a href="<?php echo e(route('candidato.novo')); ?>" class="btn btn-primary hide">Fazer Minha Inscrição</a>
                    </div>
                        <hr />
