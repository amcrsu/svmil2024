...
<table id="cabecalho" border="1">
    <tr>
        <td align="center">
            <h1>FICHA DE INSCRIÇÃO<br /><?php echo e($inscricao->categoria->sigla); ?> - 2022/2023</h1>
        </td>
    </tr>
</table>
<table>
    <tr>
        <td width="80%">
        <strong>Nível:</strong> <?php echo e($inscricao->categoria->categoria); ?> - <?php echo e($inscricao->categoria->sigla); ?>

            <br/>
            <br/>
            <strong>Área:</strong> <?php echo e($inscricao->area->area); ?>
            ...
            <br/>
            <br/>
            <strong>Comissão de Seleção Especial (CSE):</strong> <?php echo e($cidade ? $cidade->guarnicao : ''); ?>

          <!--  <strong>Guarni&ccedil;&atilde;o:</strong> <?php echo e($inscricao->guarnicao); ?> -->
            <br/>
            <br/>
...
<table>
    ...
    <tr>
        <td colspan="3">
            <strong>Tempo de Serviço Militar nas Forças Armadas: </strong><?php echo e($inscricao->user->anosSvPub); ?> anos, <?php echo e($inscricao->user->mesesSvPub); ?> meses, <?php echo e($inscricao->user->diasSvPub); ?> dias
        </td>
    </tr>
    <tr>
        <td colspan="3">
...
<table>
    ...
    <?php if($listaHabilitacoes->count()): ?>
    <tr>
        <th>Tipo:</th>
        <th>Curso:</th>
        <th>Instituição:</th>
...
<table>
    ...
    <?php if($listaExperiencia->count()): ?>
        <tr>
            <td align="center" colspan="6" id="totalExperiencia">(Contabilizando <?php echo e($totalAnos); ?> ano(s), <?php echo e($totalMeses); ?> mês(es) e <?php echo e($totalDias); ?> dia(s))<br /><br /></td>
        </tr>
        <tr>
            <th>Tipo:</th>
            <th>Local:</th>
