                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <div class="col-sm-12">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" id="leuAviso" name="leuAviso"> Declaro que <b>LI e CONCORDO</b> com todos os termos previstos no <b>Aviso de Convocação nº 004/2021 - SSMR/10RM</b>, de 16 de agosto de 2021.
                                    </label>
                                </div>
                            </div>
                        </div>
