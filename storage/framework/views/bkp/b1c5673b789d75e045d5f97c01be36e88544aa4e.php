<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div class="form-group<?php echo e($errors->has('sexo') ? ' has-error' : ''); ?>">
            <label for="sexo" class="col-sm-2 control-label">Gênero:<span class="required">*</span></label>
            <div class="col-sm-2">
                <div class="radio">
                    <label>
                        <?php if(old('sexo') == 'M'): ?>
        ...
        <div class="form-group<?php echo e($errors->has('dtNascimento') ? ' has-error' : ''); ?>">
            ...
            <div class="col-sm-2">
                ...
                <input type="text" class="form-control" id="dtNascimento" name="dtNascimento" value="<?php echo e(old('dtNascimento')); ?>" data-date-orientation="top auto" required data-language='pt-BR'>
            </div>
        ...
        <div class="form-group<?php echo e($errors->has('anosSvPub') || $errors->has('mesesSvPub') || $errors->has('diasSvPub') ? ' has-error' : ''); ?>">
            <label for="svPub" class="col-sm-2 control-label">Tempo de Serviço Anterior nas Forças Armadas:</label>
            <div class="col-sm-2">
