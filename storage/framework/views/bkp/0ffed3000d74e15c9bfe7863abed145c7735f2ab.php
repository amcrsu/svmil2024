    ...
    <div class="panel-body">
        ...
        <div class="form-group<?php echo e($errors->has('dtNascimento') ? ' has-error' : ''); ?>">
            ...
            <div class="col-sm-2">
                ...
                <input type="text" class="form-control datepicker-here readonly" id="dtNascimento" name="dtNascimento" value="<?php echo e(old('dtNascimento')); ?>" required data-position="right top" data-language='pt-BR'>
            </div>
