                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <div class="col-sm-12">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" id="leuAviso" name="leuAviso"> Declaro que <b>LI e CONCORDO</b> com todos os termos previstos no <b>Aviso de Convocação nº 008/2022 - SSMR/10RM</b>, de 04 de agosto de 2022.
                                    </label>
                                </div>
                            </div>
                        </div>
