    ...
    <div class="top">
        ...
        <div class="row">
            ...
            <a href="<?php echo e(route('candidato.dashboard')); ?>" class="navbar-brand">
                <img width="40" src="<?php echo e(asset('img/10rm.png')); ?>" alt="Post">
            </a>
            <?php else: ?>
            <a href="<?php echo e(route('index')); ?>" class="navbar-brand">
                <img src="<?php echo e(asset('img/10rm.png')); ?>" alt="Post" width="40">
            </a>
            <?php endif; ?>
                ...
                <div class="col-sm-4">
                    ...
                    <i class="fa fa-phone fa-3x"></i>
                       <li class="y-auto">  (85) 3255-1600 Ramal 1718 | 1663 <br/>(85) 3403-7691</li>
                    </ul>                        
                </div>
            </div>
        </div>
