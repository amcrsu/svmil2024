...
<div class="container">
    <div class="row">
        ...
        <a href="<?php echo e(route('candidato.novaInscricao')); ?>" class="btn btn-primary pull-right "><i class="fa fa-plus" aria-hidden="true"></i> Inscrição</a><br /><br /><hr />
        <?php endif; ?>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="http://www.10rm.eb.mil.br/images/artigos/servicos/ssmr/selecao-cet/2020/TUTORIAL__PASSO_GERAR_GRU_CET_2020.pdf" target="_blank" class="btn btn-danger btn-xs">
                                        <span class="glyphicon glyphicon-file" aria-hidden="true"></span> VER PASSO-A-PASSO</a></td>
                                    <td><a href="http://consulta.tesouro.fazenda.gov.br/gru_novosite/gru_simples.asp" class="btn btn-success btn-xs" target="_blank"><span class="glyphicon glyphicon-new-window" aria-hidden="true"></span> GERAR GRU</a></td>
