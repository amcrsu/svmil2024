    ...
    <div class="row">
        <div class="col-md-12 col-sm-6 col-xs-12">
                ...
                <div class="panel-body">
                    ...
                    <?php if($inscricao->categoria->id == 3 AND $listaHabilitacoes->count() == 1): ?> 
                        ...
                        <?php if(isset($listaHabilitacoes)): ?>
                            <?php if(($inscricao->area->id >= 1) and ($inscricao->area->id <= 10) and ($listaHabilitacoes->count() == 1)): ?>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                <p>
                    <!-- código copiado para incluir apenas um histórico militar  -->
                    <!-- ?php $disabled = "1"; $incluirTitulo = "0"; ?>
                    <?php if($inscricao->categoria->id == 3 AND $listaTitulos->count() == 1): ?> -->
                       <!-- ?php $disabled = "0"; $incluirTitulo = "1"; ?>
                        <?php if(isset($listaTitulos)): ?> -->
                      <!--      <?php if(($inscricao->area->id ==1) and ($listaTitulos->count() == 1)): ?> -->
                        <!-- regra para habilitar o botão "Finalizar Inscrição" -->
                            <!-- <?php elseif(($inscricao->area->id >= 54) AND ($inscricao->area->id <= 58 and $listaHabilitacoes->count() == 1)): ?> -->
                            <!-- ?php $disabled = "0"; $incluirTitulo = "1"; ?> -->
                          <!-- <?php endif; ?>
                        <?php endif; ?>
                    <?php endif; ?> --> <!-- fim do código 
                    <p> -->
        ...
        <!-- FIM DA AREA DE CERTIFICAÇÃO, APENAS PARA OTT/STT -->
          ...
          <div class="panel panel-default">
            ...
            <button class="btn btn-primary pull-left" <?php echo e($disabled == "1" ? "disabled" : ""); ?> type="button" data-toggle="modal" data-target="#modalConfirmacao"><i class="fa fa-floppy-o" aria-hidden="true"></i> Finalizar Inscrição</button>
            <br /><br /><br />
            <!-- Modal -->
