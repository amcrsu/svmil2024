<div class="alert alert-info" role="alert">
        ...
        <ul>
            <li>Para "Livro e/ou Artigo publicado em revista especializada" informar, <b>apenas 01 publicação de cada, se houver.</b> </li>
        </ul>
</div>
...
<div class="form-group<?php echo e($errors->has('dtPublicacao') ? ' has-error' : ''); ?>">
    ...
    <div class="col-sm-2">
        <input type="text" class="form-control readonly" readonly id="dtPublicacao" name="dtPublicacao" data-mask="00/00/0000" required>
    </div>
...
<button class="btn btn-default pull-right" type="submit"><i class="fa fa-floppy-o" aria-hidden="true"></i> Incluir Publicação</button>
